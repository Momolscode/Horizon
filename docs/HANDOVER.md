...
| E-mails de notification (type, nom du lieu, motif de refus, dates d'envoi ; **aucune adresse**) | `email_outbox` | prévenir l'auteur d'un avis retiré, d'une revendication refusée ou d'une gestion retirée | cascade à la suppression du compte ; envoyés purgés après 30 jours, abandons après 90 (`npm run mail:flush`) |
